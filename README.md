...
<!-- GETTING STARTED -->
## Getting Started
To directly test the application, skipping the installation requirements you can download an installer at this [link](https://github.com/flim-labs/fcs-py/releases/tag/v1.5) (_Note: you still need to have the FLIM LABS Data Acquisition Card_). 
...
- [FCS GUI guide](./docs/v1.5/index.md)
