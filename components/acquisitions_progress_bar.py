...
from components.settings import PROGRESS_BAR_WIDGET
...
class AcquisitionsProgressBar(QWidget):
    def __init__(self, window, parent=None):
        ...
        self.setStyleSheet(GUIStyles.set_progress_bar_widget())
    ...
    def remove_progress_bar(self, app):
        if PROGRESS_BAR_WIDGET in app.widgets:
            app.widgets[PROGRESS_BAR_WIDGET].setVisible(False)
