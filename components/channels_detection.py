...
from components.buttons import IntensityTracingButtonsActions
...
class DetectChannelsDialog(QDialog):
    def __init__(self, app):
        ...
        self.loader_pixmap = QPixmap(resource_path("assets/channel-icon-green.png"))
    ...
    def update_selected_channels(self, channels_str):
        ...
        self.app.ch_correlations = []
        self.app.settings.setValue(SETTINGS_CH_CORRELATIONS, json.dumps(self.app.ch_correlations))
