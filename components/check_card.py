...
from components.settings import CHECK_CARD_BUTTON, CHECK_CARD_MESSAGE, CHECK_CARD_WIDGET
...
class CheckCard(QWidget):
    def __init__(self, app, parent=None):
        ...
        self.setVisible(self.app.acquire_read_mode != "read")
        ...
        if CHECK_CARD_MESSAGE in app.widgets:
            ...
            app.widgets[CHECK_CARD_MESSAGE].setStyleSheet(
                GUIStyles.check_card_message(
                    color="#31c914" if not error else "#f72828"
                )
            )
